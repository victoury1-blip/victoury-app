...
function buildLabelHTML(order, config) {
  ...
  return `<div class="label-page" style="width:100mm;min-height:100mm;border:2px solid #000;font-family:'Cairo',sans-serif;padding:0;margin:0 auto;background:#fff;page-break-after:always">
...
<style>
  ...
  * { box-sizing: border-box; }
  body { margin: 0; padding: 20px; background: #f3f4f6; font-family: 'Cairo', sans-serif; }
