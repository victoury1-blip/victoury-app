...
export const statusConfig = {
  ...
  reporter:       { label: "Reporter",              bg: "bg-orange-100",  text: "text-orange-700",  border: "border-orange-300",  color: "#F97316" },
  ...
  recu_livreur:   { label: "Reçus par livreur",     bg: "bg-teal-100",    text: "text-teal-700",    border: "border-teal-300",    color: "#14B8A6" },
