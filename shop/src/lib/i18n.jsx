...
const DICT = {
  fr: {
    ...
    emailOptionnel: 'E-mail (optionnel)',
    ...
    garantiesLivraisonTitre: 'Livraison 12-24h', garantiesLivraisonTexte: 'Partout au Maroc',
    ...
    garantiesRetourTitre: 'Retour gratuit', garantiesRetourTexte: 'Sous 3 jours',
  },
  ar: {
    ...
    voirLaBoutique: 'مشاهدة المتجر', meilleureVente: '🔥 الأكثر مبيعًا', epuiseTampon: 'نفدت الكمية',
    ...
    garantiesLivraisonTitre: 'التوصيل 12-24 ساعة', garantiesLivraisonTexte: 'فجميع أنحاء المغرب',
    ...
    garantiesRetourTitre: 'إرجاع مجاني', garantiesRetourTexte: 'خلال 3 أيام',
  },
};
