...
const DICT = {
  fr: {
    ...
    achetezEnsemble: 'Souvent achetés ensemble', ajouterLaSelection: 'Obtenez cet ensemble',
  ...
  ar: {
    ...
    achetezEnsemble: 'غالبًا ما يُشترى مع', ajouterLaSelection: 'احصل على هذا الطقم',
